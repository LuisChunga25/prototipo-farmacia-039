...
export function FormularioVacuna({ onCancel, onSave }: Props) {
    const now = new Date();
        ...
        <>
            <div className="space-y-6 ml-6 mt-8">
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-xl font-semibold">Registrar Vacuna para transferencia</h2>
                </div>
                    ...
                    <div className="flex justify-between items-center border border-gray-300 rounded-md p-4 mb-4">
                        <div className="grid grid-cols-3 gap-4">
                            <div className="flex items-center gap-2">
                                ...
                                <Input id="id" value="00000005" disabled className="h-8 w-24" />
                            </div>
                            <div className="flex items-center gap-2">
                    ...
                    <div className="border border-gray-300 rounded-md p-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input value="Farmacia Inmunización" disabled />
                            </div>
                        </div>
