    ...
    <div className="container mx-auto py-6">
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Gestione el retorno de medicamentos que no han sido aplicados al paciente como parte de su tratamiento durante su hospitalización</p>
        </div>
      </div>
